const contentLetterSrart_actived = "Happy Birdday My Sister👩‍❤️‍👩" //Lời mở đầu cho bức thư
...
imgStart.src = "./img/mphuong.png";

// Gắn 1 link ảnh bất kì
let imgLetter = document.querySelector(".img");
imgLetter.src = "./img/nmphuong.png"; //Hình ảnh xuất hiện trong nội dung của bức thư sau khi bức thư được viết ra hết
